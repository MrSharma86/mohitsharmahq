...
const articles = getArticlesByCategory("discipline-fitness");
      ...
      <section className="mx-auto max-w-6xl px-6 pb-24 pt-32 sm:px-8 lg:px-12">
        <div className="max-w-3xl">
          <p className="mb-4 text-sm uppercase tracking-[0.2em] text-zinc-400">
            Writing / Reflections / Discipline & Fitness
          </p>
          ...
          <p className="mt-8 text-base leading-8 text-zinc-300 sm:text-lg">
            Thoughts on discipline, physical training, and the connection
            between physical effort and mental clarity.
          </p>
        </div>
