...
<HeroImage
  src="/images/writing/ml-algorithms/outlier-detection-isolation-forest.jpg"
  alt="Isolation Forest with End-to-End Implementation"
  caption="Isolation Forest for fraud detection."
  priority={true}
/>
