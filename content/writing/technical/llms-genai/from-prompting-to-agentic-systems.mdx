...
<HeroImage
  src="/images/writing/llms-genai/from-prompting-to-agentic-systems.jpg"
  alt="From Prompting to Agentic Systems"
  caption="Why Most Enterprise LLM Deployments Still Fail at Scale and How to Actually Make Them Work."
  priority={true}
/>
